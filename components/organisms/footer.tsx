      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Castro Barros Cavalcante - Qualidade, eficiência e excelência na prestação de serviços jurídicos
              há mais de 9 anos.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Arapiraca, AL - Sede Principal
                </p>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-4 w-4 shrink-0 text-gold" />
                <p className="text-sm text-muted-foreground">(82) 3521-0000</p>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 shrink-0 text-gold" />
                <p className="text-sm text-muted-foreground">contato@cbcadvocacia.com.br</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
              Acompanhe nossos conteúdos e fique por dentro das novidades jurídicas.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} CBC Advocacia Especializada. Todos os direitos reservados.
          </p>
          <p className="text-xs text-muted-foreground">
