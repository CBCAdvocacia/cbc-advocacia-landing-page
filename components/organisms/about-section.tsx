      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid items-start gap-12 lg:grid-cols-2">
          ...
          <AnimateOnScroll variant="fade-right" delay={200}>
            <div className="relative aspect-[14/9] overflow-hidden rounded-lg">
              <Image
          ...
          <div className="space-y-6">
            <AnimateOnScroll variant="fade-left" delay={300}>
              <p className="text-base leading-relaxed text-muted-foreground">
                ...
                <strong className="text-foreground">
                  CBC Advocacia Especializada
                </strong>{" "}
                é um escritório reconhecido em{" "}
                <strong className="text-foreground">Arapiraca/AL</strong> e em
                ...
                técnica e proximidade com o cliente.
              </p>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll variant="fade-left" delay={450}>
              <p className="text-base leading-relaxed text-muted-foreground">
                <strong className="text-foreground">
                  Contamos com uma equipe multidisciplinar composta por mais de
                  50 colaboradores, entre advogados e profissionais
                  especializados, atuando com agilidade, ética e compromisso.
                  Além da sede em Arapiraca, possuímos unidades em Teotônio
                  Vilela, Junqueiro, São Sebastião, Palmeira dos Índios e
                  Maceió,
                </strong>{" "}
                o que fortalece nossa presença regional e a agilidade na
            ...
            <AnimateOnScroll variant="fade-left" delay={600}>
              <p className="text-base leading-relaxed text-muted-foreground">
                ...
                <strong className="text-foreground">
                  assessoria jurídica para empresas, oferecendo suporte completo
                  e contínuo que garante ao empresário estar alinhado com as
                  normas legais, boas práticas e condutas adequadas,
                </strong>{" "}
                contribuindo para a prevenção de litígios judiciais e para a
            ...
            <AnimateOnScroll variant="fade-left" delay={750}>
              <p className="text-base leading-relaxed text-muted-foreground">
                ...
                defesas processuais quando necessário.
              </p>
            </AnimateOnScroll>
